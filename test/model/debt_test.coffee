...
#      clearDatabase.exec (error, result) ->
#        syncDatabase.exec (error, result) ->
#          fixturesDatabase.load '/test/model/debt_fixtures/getUserEntryById.json', (error, result)->
#            done()
#
#    it "should return debt, if user is lender", (done)->
#      debtTable.getUserEntryById 1, 1, (error, debt)->
#        expect(debt).to.have.property 'id', 1
#        done()
#
#    it "should return debt, if user is debtor", (done)->
#      debtTable.getUserEntryById 1, 2, (error, debt)->
#        expect(debt).to.have.property 'id', 2
#        done()
#
#    it "should return undefined, if debt exists but is deleted", (done)->
#      debtTable.getUserEntryById 1, 3, (error, debt)->
#        expect(debt).to.be.undefined
#        done()
#
  describe 'getAll', ()->
...
#      clearDatabase.exec (error, result) ->
#        syncDatabase.exec (error, result) ->
#          fixturesDatabase.load '/test/model/debt_fixtures/getNbOfEntriesWaitingForAcceptance.json', (error, result)->
#            done()
#
#    it "should return no 0 for user#1", (done)->
#      debtTable.getNbOfEntriesWaitingForAcceptance 1, (error, nbOfEntries)->
#        expect(nbOfEntries.aggregate).to.eql('0')
#        done()
#
#    it "should return no 3 for user#2", (done)->
#      debtTable.getNbOfEntriesWaitingForAcceptance 2, (error, nbOfEntries)->
